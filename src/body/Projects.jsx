...
const projects = [
  ...
  { id: 'pro2', name: 'Music-App', link: 'https://github.com/SanthoshGit23/Music-App' },
  { id: 'pro3', name: 'Mini e-commerce', link: 'https://github.com/SanthoshGit23/mini-e-commerce' },
  { id: 'pro4', name: 'Password generator', link: 'https://github.com/SanthoshGit23/Password-Generator' },
  { id: 'pro5', name: 'Text to Speech converter', link: 'https://github.com/SanthoshGit23/Text-to-Speech-Converter' },
   { id: 'pro7', name: 'Quizz App ', link: 'https://github.com/SanthoshGit23/Quizz' }
];
